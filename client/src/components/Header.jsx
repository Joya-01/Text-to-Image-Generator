...
const Header = () => {
  ...
  return (
    <motion.div className='flex flex-col justify-center items-center text-center my-20'
        ...
        <motion.p className='text-stone-800 mt-5 max-w-xl text-center mx-auto'
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <motion.button onClick={onClickHandler} className='flex items-center sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 gap-2 rounded-full'
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{default: {delay:0.8} ,opacity:{delay: 0.8,duration: 1} }}
            >
        ...
        <motion.div className='flex flex-wrap justify-center gap-3 mt-15'
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <motion.p className='text-stone-800 mt-3 max-w-xl text-center mx-auto'
